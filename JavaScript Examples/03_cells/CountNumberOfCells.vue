<template>
  <span
    >Click the following button to get the number of cells in Excel file</span
  >
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        content.push(`Number of Cells: ${sheet.Cells.Count}`);

        // Define the output file name
        const outputFileName = "CountNumberOfCells.txt";
