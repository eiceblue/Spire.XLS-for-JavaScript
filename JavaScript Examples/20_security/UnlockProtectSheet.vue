<template>
  <span
    >Click the following button to unlock the protect worksheet in Excel
    file</span
  >
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        // Load the files
        let inputFileName = "UnprotectProtectSheet.xlsx";
        await wasmModule.FetchFileToVFS(
          inputFileName,
          "",
        ...
        let outputFileName = "UnlockProtectSheet_output.xlsx";
        //Save the document
