<template>
  <span>Click the following button to write custom document properties</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        // Load the files
        let excelFileName = "AddCustomProperties.xlsx";
        await wasmModule.FetchFileToVFS(
          excelFileName,
          "",
        ...
        let outputFileName = "AddCustomProperties_output.txt";
