<template>
  <span
    >Click the following button to copy only the formula values and not the formula when copying cells</span
  >
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let excelFileName = "CopyOnlyFormulaValue.xlsx";
        await wasmModule.FetchFileToVFS(
          excelFileName,
          "",
        ...
        const outputFileName = "CopyOnlyFormulaValue.xlsx";
