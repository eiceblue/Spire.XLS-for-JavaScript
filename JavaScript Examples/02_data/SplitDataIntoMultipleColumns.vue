<template>
  <span
    >Click the following button to split Excel data into multiple columns</span
  >
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let excelFileName = "SplitExcelDataIntoMultipleCols.xlsx";
        await wasmModule.FetchFileToVFS(
          excelFileName,
          "",
        ...
        const outputFileName = "SplitExcelDataIntoMultipleCols_out.xlsx";
