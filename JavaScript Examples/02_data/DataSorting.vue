<template>
  <span
    >Click the following button to sort values in a specific cell range of a worksheet</span
  >
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let excelFileName = "DataSorting.xlsx";
        await wasmModule.FetchFileToVFS(
          excelFileName,
          "",
        ...
        const outputFileName = "DataSorting_out.xlsx";
