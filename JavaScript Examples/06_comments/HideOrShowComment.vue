<template>
  <span>Click the following button to hide or show excel comment</span>
...
export default {
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        let inputFileName='HideOrShowComment.xlsx';
        ...
        const outputFileName = 'HideOrShowComment-out.xlsx';
