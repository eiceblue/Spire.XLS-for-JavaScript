<template>
  <span>Click the following button to change font and size for header and footer in Excel file</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        // Input file
        let excelFileName='ChangeFontAndSizeForHeaderAndFooter.xlsx';
        ...
        //Save result file
        const outputFileName = 'ChangeFontAndSize_out.xlsx';
