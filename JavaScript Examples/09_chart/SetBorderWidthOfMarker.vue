<template>
  <span>Click the following button to set border width of marker</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let excelFileName = 'SetBorderWidthOfMarker.xlsx';
        ...
        chart.Series.get(0).DataFormat.MarkerBorderWidth = 1.5; // unit is pt
        chart.Series.get(1).DataFormat.MarkerBorderWidth = 2.5; // unit is pt

        // Save the modified workbook 
        const outputFile = 'SetBorderWidthOfMarker.xlsx';
