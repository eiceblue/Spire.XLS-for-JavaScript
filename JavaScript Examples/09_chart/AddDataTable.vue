<template>
  <span>Click the following button to add Data Table for Chart</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        let excelFileName = 'AddDataTable.xlsx';
        ...
        // Load the Excel file 
        workbook.LoadFromFile({fileName: excelFileName, version: wasmModule.ExcelVersion.Version2010});
        ...
        const outputFile = 'AddDataTable.xlsx';
