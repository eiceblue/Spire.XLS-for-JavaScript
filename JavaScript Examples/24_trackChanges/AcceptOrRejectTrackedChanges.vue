<template>
  <span>Click the following button to accept/reject track changes in Excel</span>
  ...
  setup() {
    ...
    const startProcessing = async () => {
      ...
      if (wasmModule) {
        ...
        // Load the files
        let excelFileName='TrackChanges.xlsx';
        ...
        let outputFileName = "AcceptOrRejectTrackedChanges_output.xlsx";
        //Save the document
